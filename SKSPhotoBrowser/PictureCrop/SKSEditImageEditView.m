...
@interface SKSEditImageEditView ()
...
@implementation SKSEditImageEditView
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
    ...
    if (!self.config.isDragEditBorder) {
        return nil;
    }else if (self.imageWrap.hidden == NO && self.isMoving == NO) {
...
- (UIView *)imageWrap {
    if (!_imageWrap) {
        ...
        UIImageView *topright = [[UIImageView alloc] initWithImage:[SKSPhotoResource imageNamed:@"sks_photo_top_right"]];
        topright.tag = 1;
        ...
        UIImageView *bottomLeft = [[UIImageView alloc] initWithImage:[SKSPhotoResource imageNamed:@"sks_photo_bottom_left"]];
        bottomLeft.tag = 2;
        ...
        UIImageView *bottomRight = [[UIImageView alloc] initWithImage:[SKSPhotoResource imageNamed:@"sks_photo_bottom_right"]];
        bottomRight.tag = 3;
